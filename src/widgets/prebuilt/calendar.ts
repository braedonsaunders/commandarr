...
.empty { color:#6b7280; font-size:13px; }`,
  ...
  if (!items.length) { el.innerHTML='<div class="empty">No upcoming releases</div>'; commandarr.setStatus(''); return; }
  ...
  commandarr.setStatus(items.length + ' upcoming');
}
