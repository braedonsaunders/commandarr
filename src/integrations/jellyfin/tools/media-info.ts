...
export const tool: ToolDefinition = {
  name: 'jellyfin_media_info',
  integration: 'jellyfin',
  description:
    'Get detailed metadata for a specific Jellyfin media item including codec, resolution, file size, streams, and file path. Use jellyfin_search to find item IDs.',
  parameters: {
    type: 'object',
    properties: {
      itemId: {
        type: 'string',
        description: 'The item ID to look up. Use jellyfin_search to find IDs.',
      },
    },
    required: ['itemId'],
  },
