...
export const tool: ToolDefinition = {
  name: 'jellyfin_play_control',
  integration: 'jellyfin',
  description:
    'Control playback on active Jellyfin sessions — stop, pause, or unpause. Use jellyfin_now_playing first to get session IDs.',
  parameters: {
    type: 'object',
    properties: {
      sessionId: {
        type: 'string',
        description: 'The session ID to control. Get from jellyfin_now_playing.',
      },
      action: {
        type: 'string',
