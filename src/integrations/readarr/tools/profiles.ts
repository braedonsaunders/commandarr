...
export const tool: ToolDefinition = {
  name: 'readarr_profiles',
  integration: 'readarr',
  description: 'List quality profiles configured in Readarr',
  parameters: {
    type: 'object',
    properties: {},
  },
  ...
  async handler(_params, ctx) {
    ...
    ctx.log('Fetching Readarr quality profiles...');

    const results = await client.get('/api/v1/qualityprofile');
