...
export const tool: ToolDefinition = {
  name: 'emby_library_scan',
  integration: 'emby',
  description:
    'Trigger an Emby library scan. Scans all libraries by default, or a specific library if libraryId is provided.',
  parameters: {
    type: 'object',
    properties: {
      libraryId: {
        type: 'string',
        description:
          'Optional library ID to scan. If omitted, all libraries are scanned. Use emby_libraries to find IDs.',
      },
    },
  },
  ui: {
