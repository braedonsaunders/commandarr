...
export const tool: ToolDefinition = {
  ...
  integration: 'radarr',
  description:
    'Remove an item from the Radarr download queue. Can optionally blocklist the release to prevent re-downloading, and optionally trigger a search for a replacement.',
  parameters: {
    type: 'object',
    properties: {
      queueId: {
        type: 'number',
        description: 'The queue item ID to remove (from radarr_queue results)',
      },
      blocklist: {
        type: 'boolean',
